...
public class EssencewoodstairsBlock extends VanillaForgingElements.ModElement {
	@ObjectHolder("vanillaforging:essencewoodstairs")
	public static final Block block = null;
	public EssencewoodstairsBlock(VanillaForgingElements instance) {
		super(instance, 73);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			super(new Block(Block.Properties.create(Material.ROCK)).getDefaultState(), Block.Properties.create(Material.WOOD).sound(SoundType.WOOD)
					.hardnessAndResistance(3f, 12f).lightValue(0).harvestLevel(2).harvestTool(ToolType.AXE));
