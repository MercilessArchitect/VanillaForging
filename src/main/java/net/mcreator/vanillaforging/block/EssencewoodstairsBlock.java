...
public class EssencewoodstairsBlock extends VanillaforgingModElements.ModElement {
	@ObjectHolder("vanillaforging:essencewoodstairs")
	public static final Block block = null;
	public EssencewoodstairsBlock(VanillaforgingModElements instance) {
		super(instance, 49);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			super(new Block(Block.Properties.create(Material.ROCK)).getDefaultState(), Block.Properties.create(Material.WOOD).sound(SoundType.WOOD)
					.hardnessAndResistance(3f, 12f).lightValue(0).harvestLevel(2).harvestTool(ToolType.AXE).notSolid());
			setRegistryName("essencewoodstairs");
		}
