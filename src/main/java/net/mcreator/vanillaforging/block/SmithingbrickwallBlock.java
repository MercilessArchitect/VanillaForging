...
public class SmithingbrickwallBlock extends VanillaforgingModElements.ModElement {
	@ObjectHolder("vanillaforging:smithingbrickwall")
	public static final Block block = null;
	public SmithingbrickwallBlock(VanillaforgingModElements instance) {
		super(instance, 25);
	}
	...
	public static class CustomBlock extends WallBlock {
		public CustomBlock() {
			...
			setRegistryName("smithingbrickwall");
		}
