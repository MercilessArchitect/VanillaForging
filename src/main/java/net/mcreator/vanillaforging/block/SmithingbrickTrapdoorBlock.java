...
public class SmithingbrickTrapdoorBlock extends VanillaforgingModElements.ModElement {
	@ObjectHolder("vanillaforging:smithingbricktrapdoor")
	public static final Block block = null;
	public SmithingbrickTrapdoorBlock(VanillaforgingModElements instance) {
		super(instance, 27);
	}
	...
	public static class CustomBlock extends TrapDoorBlock {
		public CustomBlock() {
			...
			setRegistryName("smithingbricktrapdoor");
		}
