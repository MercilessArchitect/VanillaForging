...
public class LightSmithingbrickFenceBlock extends VanillaForgingElements.ModElement {
	@ObjectHolder("vanillaforging:lightsmithingbrickfence")
	public static final Block block = null;
	public LightSmithingbrickFenceBlock(VanillaForgingElements instance) {
		super(instance, 49);
	}
	...
	public static class CustomBlock extends FenceBlock {
		public CustomBlock() {
			...
			setRegistryName("lightsmithingbrickfence");
		}
