...
public class LightSmithingbrickFenceBlock extends VanillaforgingModElements.ModElement {
	@ObjectHolder("vanillaforging:lightsmithingbrickfence")
	public static final Block block = null;
	public LightSmithingbrickFenceBlock(VanillaforgingModElements instance) {
		super(instance, 32);
	}
