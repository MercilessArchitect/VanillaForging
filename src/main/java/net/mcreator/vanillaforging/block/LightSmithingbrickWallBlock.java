...
public class LightSmithingbrickWallBlock extends VanillaforgingModElements.ModElement {
	@ObjectHolder("vanillaforging:lightsmithingbrickwall")
	public static final Block block = null;
	public LightSmithingbrickWallBlock(VanillaforgingModElements instance) {
		super(instance, 34);
	}
	...
	public static class CustomBlock extends WallBlock {
		public CustomBlock() {
			...
			setRegistryName("lightsmithingbrickwall");
		}
