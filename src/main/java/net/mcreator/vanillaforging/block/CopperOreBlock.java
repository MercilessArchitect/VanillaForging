...
public class CopperOreBlock extends VanillaforgingModElements.ModElement {
	@ObjectHolder("vanillaforging:copperore")
	public static final Block block = null;
	public CopperOreBlock(VanillaforgingModElements instance) {
		super(instance, 2);
	}
	...
	public void init(FMLCommonSetupEvent event) {
		for (Biome biome : ForgeRegistries.BIOMES.getValues()) {
			...
			}), block.getDefaultState(), 5)).withPlacement(Placement.COUNT_RANGE.configure(new CountRangeConfig(7, 16, 16, 64))));
		}
	}
}
