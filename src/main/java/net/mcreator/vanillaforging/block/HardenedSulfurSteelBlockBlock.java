...
public class HardenedSulfurSteelBlockBlock extends VanillaforgingModElements.ModElement {
	@ObjectHolder("vanillaforging:hardenedsulfursteelblock")
	public static final Block block = null;
	public HardenedSulfurSteelBlockBlock(VanillaforgingModElements instance) {
		super(instance, 55);
	}
