...
public class SmithingbrickstorageblockBlock extends VanillaforgingModElements.ModElement {
	@ObjectHolder("vanillaforging:smithingbrickstorageblock")
	public static final Block block = null;
	public SmithingbrickstorageblockBlock(VanillaforgingModElements instance) {
		super(instance, 21);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("smithingbrickstorageblock");
		}
