...
public class LightSmithingbrickSmoothslabBlock extends VanillaforgingModElements.ModElement {
	@ObjectHolder("vanillaforging:lightsmithingbricksmoothslab")
	public static final Block block = null;
	public LightSmithingbrickSmoothslabBlock(VanillaforgingModElements instance) {
		super(instance, 36);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("lightsmithingbricksmoothslab");
		}
