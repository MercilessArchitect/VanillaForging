...
public class SmithingbrickSlabBlock extends VanillaforgingModElements.ModElement {
	@ObjectHolder("vanillaforging:smithingbrickslab")
	public static final Block block = null;
	public SmithingbrickSlabBlock(VanillaforgingModElements instance) {
		super(instance, 26);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("smithingbrickslab");
		}
