...
public class EssencewoodlogBlock extends VanillaforgingModElements.ModElement {
	@ObjectHolder("vanillaforging:essencewoodlog")
	public static final Block block = null;
	public EssencewoodlogBlock(VanillaforgingModElements instance) {
		super(instance, 47);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("essencewoodlog");
		}
