...
public class SmithingbrickfenceBlock extends VanillaforgingModElements.ModElement {
	@ObjectHolder("vanillaforging:smithingbrickfence")
	public static final Block block = null;
	public SmithingbrickfenceBlock(VanillaforgingModElements instance) {
		super(instance, 24);
	}
	...
	public static class CustomBlock extends FenceBlock {
		public CustomBlock() {
			...
			setRegistryName("smithingbrickfence");
		}
