...
public class LightSmithingbrickslabBlock extends VanillaforgingModElements.ModElement {
	@ObjectHolder("vanillaforging:lightsmithingbrickslab")
	public static final Block block = null;
	public LightSmithingbrickslabBlock(VanillaforgingModElements instance) {
		super(instance, 33);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("lightsmithingbrickslab");
		}
