...
public class EssencewoodFenceBlock extends VanillaforgingModElements.ModElement {
	@ObjectHolder("vanillaforging:essencewoodfence")
	public static final Block block = null;
	public EssencewoodFenceBlock(VanillaforgingModElements instance) {
		super(instance, 50);
	}
	...
	public static class CustomBlock extends FenceBlock {
		public CustomBlock() {
			...
			setRegistryName("essencewoodfence");
		}
