...
public class LightSmithingbrickTrapdoorBlock extends VanillaforgingModElements.ModElement {
	@ObjectHolder("vanillaforging:lightsmithingbricktrapdoor")
	public static final Block block = null;
	public LightSmithingbrickTrapdoorBlock(VanillaforgingModElements instance) {
		super(instance, 35);
	}
	...
	public static class CustomBlock extends TrapDoorBlock {
		public CustomBlock() {
			...
			setRegistryName("lightsmithingbricktrapdoor");
		}
