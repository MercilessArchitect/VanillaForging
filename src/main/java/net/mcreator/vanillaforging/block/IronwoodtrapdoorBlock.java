...
public class IronwoodtrapdoorBlock extends VanillaforgingModElements.ModElement {
	@ObjectHolder("vanillaforging:ironwoodtrapdoor")
	public static final Block block = null;
	public IronwoodtrapdoorBlock(VanillaforgingModElements instance) {
		super(instance, 15);
	}
	...
	public static class CustomBlock extends TrapDoorBlock {
		public CustomBlock() {
			...
			setRegistryName("ironwoodtrapdoor");
		}
