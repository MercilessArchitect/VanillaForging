...
public class IronwoodFenceBlock extends VanillaforgingModElements.ModElement {
	@ObjectHolder("vanillaforging:ironwoodfence")
	public static final Block block = null;
	public IronwoodFenceBlock(VanillaforgingModElements instance) {
		super(instance, 14);
	}
