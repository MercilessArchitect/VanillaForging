...
public class IronwoodstairsBlock extends VanillaforgingModElements.ModElement {
	@ObjectHolder("vanillaforging:ironwoodstairs")
	public static final Block block = null;
	public IronwoodstairsBlock(VanillaforgingModElements instance) {
		super(instance, 12);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("ironwoodstairs");
		}
