...
public class LightSmithingbrickstairsBlock extends VanillaForgingElements.ModElement {
	@ObjectHolder("vanillaforging:lightsmithingbrickstairs")
	public static final Block block = null;
	public LightSmithingbrickstairsBlock(VanillaForgingElements instance) {
		super(instance, 48);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			super(new Block(Block.Properties.create(Material.ROCK)).getDefaultState(), Block.Properties.create(Material.ROCK).sound(SoundType.STONE)
					.hardnessAndResistance(15f, 600f).lightValue(0).harvestLevel(3).harvestTool(ToolType.PICKAXE));
