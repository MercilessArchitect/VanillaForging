...
public class LightSmithingbrickstairsBlock extends VanillaforgingModElements.ModElement {
	@ObjectHolder("vanillaforging:lightsmithingbrickstairs")
	public static final Block block = null;
	public LightSmithingbrickstairsBlock(VanillaforgingModElements instance) {
		super(instance, 31);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			super(new Block(Block.Properties.create(Material.ROCK)).getDefaultState(), Block.Properties.create(Material.ROCK).sound(SoundType.STONE)
					.hardnessAndResistance(15f, 600f).lightValue(0).harvestLevel(3).harvestTool(ToolType.PICKAXE).notSolid());
			setRegistryName("lightsmithingbrickstairs");
		}
