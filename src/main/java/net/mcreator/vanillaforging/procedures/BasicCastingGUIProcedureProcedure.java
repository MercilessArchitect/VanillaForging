...
public class BasicCastingGUIProcedureProcedure extends VanillaforgingModElements.ModElement {
	public BasicCastingGUIProcedureProcedure(VanillaforgingModElements instance) {
		super(instance, 207);
		...
		if ((((new Object() {
			...
			}
			{
				...
				if (_ent != null) {
					...
					final ItemStack _setstack = new ItemStack(HardenedSulfurSteelIngotItem.block, (int) (1));
