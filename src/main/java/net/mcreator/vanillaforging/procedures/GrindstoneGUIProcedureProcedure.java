...
public class GrindstoneGUIProcedureProcedure extends VanillaforgingModElements.ModElement {
	public GrindstoneGUIProcedureProcedure(VanillaforgingModElements instance) {
		super(instance, 228);
	}
	...
	public static void executeProcedure(java.util.HashMap<String, Object> dependencies) {
		...
		if ((((new Object() {
			...
			}
			{
				...
				if (_ent != null) {
					final int _sltid = (int) (3);
					final ItemStack _setstack = new ItemStack(EmeraldDustItem.block, (int) (1));
					_setstack.setCount((int) ((new Object() {
						public int getAmount(BlockPos pos, int sltid) {
							AtomicInteger _retval = new AtomicInteger(0);
							TileEntity _ent = world.getTileEntity(pos);
		...
		if ((((new Object() {
			...
			}
			{
				...
				if (_ent != null) {
					final int _sltid = (int) (3);
					final ItemStack _setstack = new ItemStack(HardenedSulfurSteelDustItem.block, (int) (1));
					_setstack.setCount((int) ((new Object() {
						public int getAmount(BlockPos pos, int sltid) {
							AtomicInteger _retval = new AtomicInteger(0);
							TileEntity _ent = world.getTileEntity(pos);
		...
		if ((((new Object() {
			...
			}
			{
				...
				if (_ent != null) {
					final int _sltid = (int) (3);
					final ItemStack _setstack = new ItemStack(StardustItem.block, (int) (1));
					_setstack.setCount((int) ((new Object() {
						public int getAmount(BlockPos pos, int sltid) {
							AtomicInteger _retval = new AtomicInteger(0);
							TileEntity _ent = world.getTileEntity(pos);
		...
		if ((((new Object() {
			...
			}
			{
				...
				if (_ent != null) {
					final int _sltid = (int) (3);
					final ItemStack _setstack = new ItemStack(BaseDustItem.block, (int) (1));
					_setstack.setCount((int) ((new Object() {
						public int getAmount(BlockPos pos, int sltid) {
							AtomicInteger _retval = new AtomicInteger(0);
							TileEntity _ent = world.getTileEntity(pos);
		...
		if ((((new Object() {
			...
			}
			{
				...
				if (_ent != null) {
					final int _sltid = (int) (3);
					final ItemStack _setstack = new ItemStack(WootzSulfurSteelDustItem.block, (int) (1));
					_setstack.setCount((int) ((new Object() {
						public int getAmount(BlockPos pos, int sltid) {
							AtomicInteger _retval = new AtomicInteger(0);
							TileEntity _ent = world.getTileEntity(pos);
