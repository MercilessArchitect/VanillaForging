...
public class MetallurgySmithingProcedureProcedure extends VanillaForgingElements.ModElement {
	public MetallurgySmithingProcedureProcedure(VanillaForgingElements instance) {
		super(instance, 234);
	}
	...
	public static void executeProcedure(java.util.HashMap<String, Object> dependencies) {
		...
		if (((((new Object() {
		...
		}.getAmount(new BlockPos((int) x, (int) y, (int) z), (int) (15))) < 16))) && ((((new Object() {
					...
					public ItemStack getItemStack(BlockPos pos, int sltid) {
						...
						&& (((((new Object() {
							...
							public ItemStack getItemStack(BlockPos pos, int sltid) {
								...
								}.getAmount(new BlockPos((int) x, (int) y, (int) z), (int) (15))) <= 15) && ((new Object() {
									public ItemStack getItemStack(BlockPos pos, int sltid) {
										TileEntity inv = world.getTileEntity(pos);
										if (inv instanceof LockableLootTileEntity)
											return ((LockableLootTileEntity) inv).getStackInSlot(sltid);
			...
			}
			{
				...
				if (inv != null && (inv instanceof LockableLootTileEntity)) {
					ItemStack _setstack = new ItemStack(ScrapItem.block, (int) (1));
			...
			}
			{
				TileEntity inv = world.getTileEntity(new BlockPos((int) x, (int) y, (int) z));
				if (inv != null && (inv instanceof LockableLootTileEntity)) {
					ItemStack _setstack = new ItemStack(WootzsteelchunkItem.block, (int) (1));
					_setstack.setCount(((new Object() {
						public int getAmount(BlockPos pos, int sltid) {
							TileEntity inv = world.getTileEntity(pos);
							if (inv instanceof LockableLootTileEntity) {
			...
			}
			{
				...
				if (inv != null && (inv instanceof LockableLootTileEntity)) {
					...
					((LockableLootTileEntity) inv).setInventorySlotContents((int) (15), _setstack);
				}
			}
		}
	}
