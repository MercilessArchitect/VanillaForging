...
public class MetallurgyTableGUIProcedureProcedure extends VanillaforgingModElements.ModElement {
	public MetallurgyTableGUIProcedureProcedure(VanillaforgingModElements instance) {
		super(instance, 230);
	}
	...
	public static void executeProcedure(java.util.HashMap<String, Object> dependencies) {
		...
		if ((((new Object() {
		...
		}.getAmount(new BlockPos((int) x, (int) y, (int) z), (int) (18))) < 64) && ((((new Object() {
			...
			}
			{
				...
				if (_ent != null) {
					...
					final ItemStack _setstack = new ItemStack(WootzSulfurSteelBucketItem.block, (int) (1));
