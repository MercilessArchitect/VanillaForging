...
public class Portalpillarvar2Structure extends VanillaforgingModElements.ModElement {
	public Portalpillarvar2Structure(VanillaforgingModElements instance) {
		super(instance, 154);
	}
				...
				if ((random.nextInt(1000000) + 1) <= 10000) {
					...
					for (int a = 0; a < count; a++) {
						...
						Template template = ((ServerWorld) iworld.getWorld()).getSaveHandler().getStructureTemplateManager()
								.getTemplateDefaulted(new ResourceLocation("vanillaforging", "portalpillarvar2"));
						if (template == null)
							return false;
