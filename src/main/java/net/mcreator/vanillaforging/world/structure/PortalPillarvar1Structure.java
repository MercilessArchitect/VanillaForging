...
package net.mcreator.vanillaforging.world.structure;
...
public class PortalPillarvar1Structure extends VanillaforgingModElements.ModElement {
	public PortalPillarvar1Structure(VanillaforgingModElements instance) {
		super(instance, 153);
	}
				...
				if ((random.nextInt(1000000) + 1) <= 10000) {
					...
					for (int a = 0; a < count; a++) {
						...
						Template template = ((ServerWorld) iworld.getWorld()).getSaveHandler().getStructureTemplateManager()
								.getTemplateDefaulted(new ResourceLocation("vanillaforging", "portalpillarvar1"));
						if (template == null)
							return false;
