...
public class BasicCastingGUIGui extends VanillaForgingElements.ModElement {
	...
	public static class GuiContainerMod extends Container implements Supplier<Map<Integer, Slot>> {
		...
		public GuiContainerMod(int id, PlayerInventory inv, PacketBuffer extraData) {
			...
			this.customSlots.put(0, this.addSlot(new Slot(internal, 0, 53, 11) {
			}));
			this.customSlots.put(1, this.addSlot(new Slot(internal, 1, 53, 38) {
			}));
			this.customSlots.put(2, this.addSlot(new Slot(internal, 2, 53, 65) {
			}));
			this.customSlots.put(4, this.addSlot(new Slot(internal, 4, 17, 56) {
			}));
			this.customSlots.put(3, this.addSlot(new Slot(internal, 3, 17, 20) {
			}));
			this.customSlots.put(5, this.addSlot(new Slot(internal, 5, 134, 38) {
				@Override
