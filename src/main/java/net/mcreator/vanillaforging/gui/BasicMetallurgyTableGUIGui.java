...
public class BasicMetallurgyTableGUIGui extends VanillaForgingElements.ModElement {
	...
	public void registerContainer(RegistryEvent.Register<ContainerType<?>> event) {
		event.getRegistry().register(containerType.setRegistryName("basicmetallurgytablegui"));
	}
	...
	public static class GuiWindow extends ContainerScreen<GuiContainerMod> {
		...
		private static final ResourceLocation texture = new ResourceLocation("vanillaforging:textures/basicmetallurgytablegui.png");
		@Override
