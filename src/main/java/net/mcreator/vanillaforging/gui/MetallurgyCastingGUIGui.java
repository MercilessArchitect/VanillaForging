...
public class MetallurgyCastingGUIGui extends VanillaforgingModElements.ModElement {
	public static HashMap guistate = new HashMap();
	private static ContainerType<GuiContainerMod> containerType = null;
	public MetallurgyCastingGUIGui(VanillaforgingModElements instance) {
		super(instance, 231);
	...
	public static class GuiContainerMod extends Container implements Supplier<Map<Integer, Slot>> {
		...
		public GuiContainerMod(int id, PlayerInventory inv, PacketBuffer extraData) {
			...
			this.customSlots.put(1, this.addSlot(new SlotItemHandler(internal, 1, 34, 3) {
			}));
			this.customSlots.put(2, this.addSlot(new SlotItemHandler(internal, 2, 52, 3) {
			}));
			this.customSlots.put(3, this.addSlot(new SlotItemHandler(internal, 3, 34, 57) {
			}));
			this.customSlots.put(4, this.addSlot(new SlotItemHandler(internal, 4, 52, 57) {
			}));
			this.customSlots.put(5, this.addSlot(new SlotItemHandler(internal, 5, 7, 21) {
			}));
			this.customSlots.put(6, this.addSlot(new SlotItemHandler(internal, 6, 7, 39) {
			}));
