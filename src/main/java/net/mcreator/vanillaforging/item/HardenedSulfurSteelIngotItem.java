...
public class HardenedSulfurSteelIngotItem extends VanillaforgingModElements.ModElement {
	@ObjectHolder("vanillaforging:hardenedsulfursteelingot")
	public static final Item block = null;
	public HardenedSulfurSteelIngotItem(VanillaforgingModElements instance) {
		super(instance, 67);
	}
