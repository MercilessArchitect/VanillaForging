...
public class SulfuralloypasteItem extends VanillaforgingModElements.ModElement {
	@ObjectHolder("vanillaforging:sulfuralloypaste")
	public static final Item block = null;
	public SulfuralloypasteItem(VanillaforgingModElements instance) {
		super(instance, 60);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("sulfuralloypaste");
		}
