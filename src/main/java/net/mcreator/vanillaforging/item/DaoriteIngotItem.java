...
public class DaoriteIngotItem extends VanillaforgingModElements.ModElement {
	@ObjectHolder("vanillaforging:daoriteingot")
	public static final Item block = null;
	public DaoriteIngotItem(VanillaforgingModElements instance) {
		super(instance, 89);
	}
