...
public class WeakCastingAlloyItem extends VanillaforgingModElements.ModElement {
	@ObjectHolder("vanillaforging:weakcastingalloy")
	public static final Item block = null;
	public WeakCastingAlloyItem(VanillaforgingModElements instance) {
		super(instance, 86);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("weakcastingalloy");
		}
