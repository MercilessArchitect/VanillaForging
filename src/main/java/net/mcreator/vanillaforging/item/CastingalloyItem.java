...
public class CastingalloyItem extends VanillaforgingModElements.ModElement {
	@ObjectHolder("vanillaforging:castingalloy")
	public static final Item block = null;
	public CastingalloyItem(VanillaforgingModElements instance) {
		super(instance, 85);
	}
