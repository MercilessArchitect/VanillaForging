...
public class SmithingBrickItem extends VanillaforgingModElements.ModElement {
	@ObjectHolder("vanillaforging:smithingbrick")
	public static final Item block = null;
	public SmithingBrickItem(VanillaforgingModElements instance) {
		super(instance, 77);
	}
