...
public class PlateCastItem extends VanillaforgingModElements.ModElement {
	@ObjectHolder("vanillaforging:platecast")
	public static final Item block = null;
	public PlateCastItem(VanillaforgingModElements instance) {
		super(instance, 102);
	}
