...
public class ScrapItem extends VanillaforgingModElements.ModElement {
	@ObjectHolder("vanillaforging:scrap")
	public static final Item block = null;
	public ScrapItem(VanillaforgingModElements instance) {
		super(instance, 115);
	}
