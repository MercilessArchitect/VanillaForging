...
public class WootzSteelBaseBucketItem extends VanillaforgingModElements.ModElement {
	@ObjectHolder("vanillaforging:wootzsteelbasebucket")
	public static final Item block = null;
	public WootzSteelBaseBucketItem(VanillaforgingModElements instance) {
		super(instance, 114);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("wootzsteelbasebucket");
		}
