...
public class IronplateItem extends VanillaforgingModElements.ModElement {
	@ObjectHolder("vanillaforging:ironplate")
	public static final Item block = null;
	public IronplateItem(VanillaforgingModElements instance) {
		super(instance, 98);
	}
