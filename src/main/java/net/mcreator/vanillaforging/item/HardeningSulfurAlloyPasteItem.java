...
public class HardeningSulfurAlloyPasteItem extends VanillaforgingModElements.ModElement {
	@ObjectHolder("vanillaforging:hardeningsulfuralloypaste")
	public static final Item block = null;
	public HardeningSulfurAlloyPasteItem(VanillaforgingModElements instance) {
		super(instance, 61);
	}
