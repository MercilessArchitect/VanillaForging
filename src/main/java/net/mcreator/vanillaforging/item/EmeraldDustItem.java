...
public class EmeraldDustItem extends VanillaforgingModElements.ModElement {
	@ObjectHolder("vanillaforging:emeralddust")
	public static final Item block = null;
	public EmeraldDustItem(VanillaforgingModElements instance) {
		super(instance, 81);
	}
