...
public class LightSmithingbrickItem extends VanillaforgingModElements.ModElement {
	@ObjectHolder("vanillaforging:lightsmithingbrick")
	public static final Item block = null;
	public LightSmithingbrickItem(VanillaforgingModElements instance) {
		super(instance, 78);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("lightsmithingbrick");
		}
