...
public class HardenedSulfurSteelGearItem extends VanillaforgingModElements.ModElement {
	@ObjectHolder("vanillaforging:hardenedsulfursteelgear")
	public static final Item block = null;
	public HardenedSulfurSteelGearItem(VanillaforgingModElements instance) {
		super(instance, 68);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("hardenedsulfursteelgear");
		}
