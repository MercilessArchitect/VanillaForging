...
public class SteelHardeningDustItem extends VanillaforgingModElements.ModElement {
	@ObjectHolder("vanillaforging:steelhardeningdust")
	public static final Item block = null;
	public SteelHardeningDustItem(VanillaforgingModElements instance) {
		super(instance, 111);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("steelhardeningdust");
		}
